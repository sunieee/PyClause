...
PYBIND11_MODULE(c_clause, m) {
    ...
    py::class_<ComboHandler>(m, "ComboHandler")
        ...
        .def("get_binary_weight", &ComboHandler::getBinaryWeight)
        .def("set_binary_weight", &ComboHandler::setBinaryWeight, py::arg("weight"))
        .def("get_aggregate_sharpness", &ComboHandler::getAggregateSharpness)
        .def("set_aggregate_sharpness", &ComboHandler::setAggregateSharpness, py::arg("sharpness"))
        .def("get_negative_weight", &ComboHandler::getNegativeWeight)
        .def("set_negative_weight", &ComboHandler::setNegativeWeight, py::arg("weight"))
        .def("get_positive_weight", &ComboHandler::getPositiveWeight)
        .def("set_positive_weight", &ComboHandler::setPositiveWeight, py::arg("weight"))
        .def("get_positive_method", &ComboHandler::getPositiveMethod)
